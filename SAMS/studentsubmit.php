...
$qs1="INSERT INTO emails VALUES ('".$_POST['idn']."','".$_POST['email']."')";

$results1s = @mysql_query ($qs1);



$q12="INSERT INTO dup_users (user_id,First_Name, Last_Name) VALUES ('".$_POST['idn']."','".$_POST['fname']."','".$_POST['lname']."')";

$results12 = @mysql_query ($q12);
